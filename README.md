...
Tables will be auto-created using JPA (Hibernate).

⚡ Quick Setup (For Reviewer)

To run quickly, update only:
...
⚠️ Important Notes
Backend is not deployed due to free-tier limitations
Project runs fully in local environment
APIs are tested using Postman

🚀 Future Improvements
Backend deployment (Docker + Cloud)
Activity logs
Pagination & advanced analytics
UI/UX improvements
